 ...
 *  - Subagents follow the same first-request bootstrap as top-level sessions;
 *    this keeps the Anchored Standard trajectory invariant across delegation.
...
export function apply(ctx, config) {
  ...
  const promotion = createEpochPromotion(promoteEvents, { includeSubagents: true })
