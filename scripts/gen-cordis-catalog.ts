...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  capabilityCapsules: 'orchestration.md',
  compaction: 'compaction.md',
  continualHarness: 'orchestration.md',
  continualHarnessSkills: 'orchestration.md',
  contextCompiler: 'orchestration.md',
  cordisInspect: 'extensions.md',
  credentials: 'credentials.md',
  debates: 'orchestration.md',
  ...
  taskTemplates: 'system-prompt.md',
  jobs: 'jobs.md',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'goal': 'goal.md',
  'llm': 'llm-streaming.md',
  'physical-operator': 'physical-operator.md',
  'session': 'session.md',
  'settings': 'settings.md',
  'skills': 'skills.md',
  'subagent': 'subagent.md',
  'system-prompt': 'system-prompt.md',
  'task-template': 'system-prompt.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CapabilityUpdateReceipt: 'orchestration.md',
  CapabilityUpdateRequest: 'orchestration.md',
  CapsuleCatalogSnapshot: 'orchestration.md',
  CapsuleResolutionRequest: 'orchestration.md',
  CapsuleSnapshotRequest: 'orchestration.md',
  ContextCompileRequest: 'orchestration.md',
  ...
  ContinualHarnessJsonValue: 'orchestration.md',
  ContinualHarnessListRequest: 'orchestration.md',
  ContinualHarnessManagedEntryV2: 'orchestration.md',
  ContinualHarnessOutcomeRequest: 'orchestration.md',
  ContinualHarnessRefinementApplyReceiptV1: 'orchestration.md',
  ContinualHarnessRefinementApplyRequest: 'orchestration.md',
  ContinualHarnessRefinementFlushRequest: 'orchestration.md',
  ContinualHarnessRefinementListRequest: 'orchestration.md',
  ContinualHarnessRefinementPlanRequest: 'orchestration.md',
  ContinualHarnessRefinementPlanV1: 'orchestration.md',
  ContinualHarnessRollbackRequest: 'orchestration.md',
  ContinualHarnessScopeRequest: 'orchestration.md',
  ContinualHarnessSnapshotRequest: 'orchestration.md',
  ContinualHarnessSnapshotV1: 'orchestration.md',
  ContinualHarnessTypeScriptSkillModule: 'orchestration.md',
  ContinualHarnessUpdateRequest: 'orchestration.md',
  DebateControlRequestV1: 'orchestration.md',
  DebateEventPageV1: 'orchestration.md',
  DebateEventReadRequestV1: 'orchestration.md',
  DebateRunSnapshotV1: 'orchestration.md',
  DebateRunSummaryV1: 'orchestration.md',
  ...
  ModelWorkerExecuteRequest: 'orchestration.md',
  ModelWorkerProvider: 'orchestration.md',
  ModelWorkerResult: 'orchestration.md',
  OrchestrationArtifactRef: 'orchestration.md',
  OrchestrationClusterHeartbeatRequest: 'orchestration.md',
  OrchestrationClusterHeartbeatResponse: 'orchestration.md',
  OrchestrationClusterInstallReceipt: 'orchestration.md',
  OrchestrationClusterInstallRequest: 'orchestration.md',
  OrchestrationClusterReplicaV1: 'orchestration.md',
  OrchestrationClusterStatus: 'orchestration.md',
  OrchestrationClusterVoteRequest: 'orchestration.md',
  OrchestrationClusterVoteResponse: 'orchestration.md',
  OrchestrationCompilationV1: 'orchestration.md',
  OrchestrationCompileRequest: 'orchestration.md',
  OrchestrationControlRequest: 'orchestration.md',
  OrchestrationAutoRefineIndeterminateRequest: 'orchestration.md',
  OrchestrationDecisionRequest: 'orchestration.md',
  ...
  RlmCellExecuteRequest: 'orchestration.md',
  RlmCellResultV1: 'orchestration.md',
  RlmChildExecution: 'orchestration.md',
  RlmChildHandleV1: 'orchestration.md',
  RlmChildId: 'orchestration.md',
  RlmChildSnapshotV1: 'orchestration.md',
  RlmChildSpawnRequest: 'orchestration.md',
  RlmCommandId: 'orchestration.md',
  RlmCommandReceiptSnapshotV1: 'orchestration.md',
  RlmCompactRunRequest: 'orchestration.md',
  RlmCompactRunResultV1: 'orchestration.md',
  RlmControlAttachRequestV1: 'orchestration.md',
  RlmControlAttachResultV1: 'orchestration.md',
  RlmControlDetachRequestV1: 'orchestration.md',
  RlmControlDetachResultV1: 'orchestration.md',
  RlmControlInputRequestV1: 'orchestration.md',
  RlmControlInputResultV1: 'orchestration.md',
  RlmDrainResultV1: 'orchestration.md',
  RlmEventReadRequest: 'orchestration.md',
  RlmExecutionPlanV1: 'orchestration.md',
  RlmFamilyRosterV1: 'orchestration.md',
  RlmGoalContinuationClaimV1: 'orchestration.md',
  RlmGoalSetRequest: 'orchestration.md',
  RlmGoalUsageAccountRequest: 'orchestration.md',
  RlmGoalV1: 'orchestration.md',
  RlmHeartbeatClaimV1: 'orchestration.md',
  RlmHeartbeatCreateRequest: 'orchestration.md',
  RlmHeartbeatUpdateRequest: 'orchestration.md',
  RlmHeartbeatV1: 'orchestration.md',
  RlmIndeterminateResolutionRequest: 'orchestration.md',
  RlmJsonValue: 'orchestration.md',
  RlmMessageReadRequest: 'orchestration.md',
  RlmMessageSendRequest: 'orchestration.md',
  RlmMessageV1: 'orchestration.md',
  RlmModelToolBridgeV1: 'orchestration.md',
  RlmRuntimeCreateRequest: 'orchestration.md',
  RlmRuntimeEventV1: 'orchestration.md',
  RlmRuntimeHostBindings: 'orchestration.md',
  RlmRuntimeSessionId: 'orchestration.md',
  RlmRuntimeSessionSnapshotV1: 'orchestration.md',
  RlmStrategyRequest: 'orchestration.md',
  ResidentCompactRequest: 'physical-operator.md',
  ResidentCompactResult: 'physical-operator.md',
  Agent: 'core.md',
  ...
  SessionPersistenceRevision: 'persistence.md',
  SessionRawArtifact: 'persistence.md',
  SessionReplica: 'persistence.md',
  SessionReplicationResult: 'persistence.md',
  ...
  SpillRef: 'spill.md',
  PhysicalOperator: 'physical-operator.md',
  PhysicalOperatorAvailability: 'physical-operator.md',
  PhysicalOperatorDescriptor: 'physical-operator.md',
  PhysicalOperatorExecutionEndInfo: 'physical-operator.md',
  PhysicalOperatorExecutionId: 'physical-operator.md',
  PhysicalOperatorExecutionInfo: 'physical-operator.md',
  ...
  PhysicalOperatorStatus: 'physical-operator.md',
  PhysicalOperatorStopReason: 'physical-operator.md',
  PhysicalOperatorStopReasonMap: 'physical-operator.md',
  ResidentEvent: 'physical-operator.md',
  ResidentEventPage: 'physical-operator.md',
  ResidentCliProduct: 'physical-operator.md',
  ResidentCliRuntimeStatus: 'physical-operator.md',
  ResidentCliUpdateResult: 'physical-operator.md',
  ResidentEventReadRequest: 'physical-operator.md',
  ResidentExecuteRequest: 'physical-operator.md',
  ResidentHealth: 'physical-operator.md',
  ResidentHealthReason: 'physical-operator.md',
  ResidentIndeterminateResolutionRequest: 'physical-operator.md',
  ResidentInterruptRequest: 'physical-operator.md',
  ResidentLifecycle: 'physical-operator.md',
  ResidentOperatorCommandId: 'physical-operator.md',
  ...
  SystemPrompt: 'system-prompt.md',
  TaskTemplate: 'system-prompt.md',
  TaskTemplateChangeKind: 'system-prompt.md',
  TaskTemplateDraft: 'system-prompt.md',
  TaskTemplateId: 'system-prompt.md',
  TaskTemplatePatch: 'system-prompt.md',
  TaskTemplatePersonalization: 'system-prompt.md',
  TaskTemplateRevision: 'system-prompt.md',
  TaskTemplateSelection: 'system-prompt.md',
  TaskTemplateSelectionRequest: 'system-prompt.md',
  ...
  BrowserCapabilityV1: 'browser.md',
  BrowserExecutionLayerV1: 'browser.md',
  BrowserProvider: 'browser.md',
  BrowserRunPlanV1: 'browser.md',
  BrowserRunProgramResultV1: 'browser.md',
  BrowserRunProgramV1: 'browser.md',
  BrowserRunResultV1: 'browser.md',
