...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/orchestration/continual-harness': { kind: 'none', reason: 'The abstract Continuous Harness seam emits immutable snapshots and registers no model-facing prompt or schema.' },
  'packages/orchestration/continual-harness-local': { kind: 'indirect', reason: 'The local Provider emits bounded entries consumed only by the orchestration context pipeline.' },
  'packages/orchestration/model-allocation': { kind: 'none', reason: 'The abstract allocation seam emits a sealed model plan and registers no model-facing prompt or schema.' },
  'packages/orchestration/model-allocation-local': { kind: 'indirect', reason: 'The quota-aware Provider returns a model plan consumed only by the orchestration execution-plan pipeline.' },
  'packages/orchestration/model-worker': { kind: 'none', reason: 'The model-worker registry is a Provider seam and exposes no direct model-facing prompt or schema.' },
  ...
  'packages/client/ui-remote-modules': { kind: 'none', reason: 'Browser-side configured application frames; registers nothing model-facing.' },
  ...
  'packages/host/remote-auth': { kind: 'none', reason: 'The Server authentication authority registers no prompt, tool, message, or provider request.' },
