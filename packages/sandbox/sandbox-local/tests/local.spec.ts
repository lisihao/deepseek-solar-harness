 ...
 * scripts, so supported POSIX profile dialects, ladder selection, verdict
 * caching, probe-report parsing, per-rung denial signatures, and fail-closed
 * behavior are all exercised through the real `confine()` path.
 */
