...
| [`ui-remote-modules/`](ui-remote-modules/README.md) | Installable multi-instance plugin that embeds user-configured Web applications as vertical sidebar entries. |
