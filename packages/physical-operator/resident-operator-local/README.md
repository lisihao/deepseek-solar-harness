...
- Protocol version 4 and state schema version 3 support local Unix sockets and macOS acceptance; schemas v1 and v2 migrate additively, while Windows named pipes are deferred.
