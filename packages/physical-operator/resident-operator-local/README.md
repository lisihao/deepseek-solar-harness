...
- Protocol version 10 and state schema version 5 support local Unix sockets and macOS acceptance; schemas v1 through v3 migrate into the compatibility `legacy` lane, schema v4 adds the compaction Receipt table, and Windows named pipes are deferred.
