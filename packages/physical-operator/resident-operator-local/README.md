...
- Protocol version 2 and state schema version 2 support local Unix sockets and macOS acceptance; schema v1 migrates additively, while Windows named pipes are deferred.
