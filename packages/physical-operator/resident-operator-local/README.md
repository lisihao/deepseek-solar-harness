...
- Protocol version 5 and state schema version 4 support local Unix sockets and macOS acceptance; schemas v1 through v3 migrate into the compatibility `legacy` lane, while Windows named pipes are deferred.
