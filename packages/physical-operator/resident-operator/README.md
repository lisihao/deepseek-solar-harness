...
- Human write takeover and control leases are not part of protocol version 10.
- A durable Jobs projection and affinity scheduler are intentionally separate consumers.
- Version 10 is local-provider oriented; remote transports and Windows named pipes are deferred.
