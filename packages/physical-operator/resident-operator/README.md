...
- Protocol version 12 adds DSH-tool-authoritative execution; human write takeover and control leases remain deferred.
- A durable Jobs projection and affinity scheduler are intentionally separate consumers.
- Version 12 is local-provider oriented; remote transports and Windows named pipes are deferred.
