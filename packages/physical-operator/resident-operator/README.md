...
- Protocol version 14 carries the optional sealed `NativeContext` identity; human write takeover and control leases remain deferred.
- A durable Jobs projection and affinity scheduler are intentionally separate consumers.
- Version 14 is local-provider oriented; remote transports and Windows named pipes are deferred.
