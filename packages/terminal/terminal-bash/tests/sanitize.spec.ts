...
describe('TerminalSanitizer', () => {
  it('removes split CSI and owned OSC prompt markers', () => {
    ...
    expect(sanitizer.push('D;0\x07__DSH_PERSISTENT_BASH_PROMPT__ ')).toEqual({ text: '__DSH_PERSISTENT_BASH_PROMPT__ ', prompt: true, promptTail: '__DSH_PERSISTENT_BASH_PROMPT__ ' })
  })
  ...
  it('reports printable prompt text that follows a marker in a later chunk', () => {
    ...
    expect(sanitizer.push('__DSH_PERSISTENT_BASH_PROMPT__ ')).toEqual({ text: '__DSH_PERSISTENT_BASH_PROMPT__ ', prompt: false, promptTail: '__DSH_PERSISTENT_BASH_PROMPT__ ' })
  })
