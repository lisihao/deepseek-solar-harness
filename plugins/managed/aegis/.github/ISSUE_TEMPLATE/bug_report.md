...
## Is this a Aegis issue or a platform issue?
<!-- Aegis is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Aegis installed.

     If the problem persists without Aegis, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Aegis installed
