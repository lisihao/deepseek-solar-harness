...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/aegis
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/aegis-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using aegis:subagent-driven-development. The plan is at: $PLAN_PATH"
