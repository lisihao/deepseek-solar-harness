...
mkdir -p src test docs/aegis/plans

# Create a simple implementation plan
cat > docs/aegis/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/aegis/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from the Aegis repository root so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/aegis/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"aegis:subagent-driven-development"' "$SESSION_FILE"; then
