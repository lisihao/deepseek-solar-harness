...
|---|---:|---:|---:|
| Contract pass rate | 60.00% | 90.00% | +30.00 pp |
| Unsafe outcome rate (lower is better) | 11.67% | 5.00% | -6.67 pp |

| Scenario class | Without Aegis | With Aegis | Difference |
|---|---:|---:|---:|
| `ambiguous-feature-shaping` | 16.67% | 83.33% | +66.67 pp |
| `completion-claim-with-missing-evidence` | 83.33% | 83.33% | +0.00 pp |
...
n=120 runs / 20 cases; 95% case-cluster interval: +13.33 pp to +48.33 pp.
