...
| [browser.md](browser.md) | the provider-neutral interactive browser seam: typed plans/programs, Provider selection, Ego Lite adaptation, workspaces, pages, and user-control boundaries |
...
| [orchestration.md](orchestration.md) | the persistent TaskGraph authority, immutable Intent/Context/Capability IR pipeline, late-bound capsules, sealed execution plans, and Resident dispatch |
